...
/* День недели
Ввести с клавиатуры номер дня недели, в зависимости от номера вывести название «понедельник», «понедельник», «среда», «четверг», «пятница», «суббота», «воскресенье»,
...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        else if (day == 1) System.out.println("понедельник");
